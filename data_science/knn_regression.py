...
plt.plot(df_adv["TV"], df_adv["Sales"], 'kx')
...
answer1 = 'k = 10 appears to be the best choice because it provides a balance between overfitting and underfitting. k = 1 is too sensitive to individual observations, while k = 70 oversmooths the relationship and misses important trends in the data.'
